...
const Commands = {
  ...
  squad: [Object, 2, 1, function(data) {
    for (let i = 0; i < 10; i++) servers[this.room].ai.push(new AI(Math.floor(this.x) / 100) * 100 + 10, Math.floor(this.y) / 100) * 100 + 10, 3, this.rank, Engine.getTeam(this.team), servers[this.room]));
  }],
