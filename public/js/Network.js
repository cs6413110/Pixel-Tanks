class Network {
    ...
    static load(pack) {
      ...
      for (const rarity of ['common', 'uncommon', 'rare', 'epic', 'legendary', 'mythic']) for (const cosmetic of pack.cosmetic[rarity]) Network.perImage(cosmetic, host+'/'+pack.cosmetic.path+'/'+cosmetic, 'cosmetics');
    }
    static timeout = 15;
