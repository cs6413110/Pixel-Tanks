class Shot {
  ...
  init(x, y, r, type, team, rank, host) {
    ...
    this.x = this.sx = x+(this.xm = Math.cos(Math.PI*r/180)*Shot.settings[this.type][1])*3.9;
    this.y = this.sy = y+(this.ym = Math.sin(Math.PI*r/180)*Shot.settings[this.type][1])*3.9;
