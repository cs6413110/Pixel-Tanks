  ...
  collision(x, y) {
    for (const cell of this.cells) {
      ...
      for (const e of [...this.host.cells[c[0]][c[1]]].sort((a, b) => this.score(b) - this.score(a))) {
        ...
        if (e instanceof Block && e.c && Engine.collision(x, y, 10, 10, e.x, e.y, size, size)) return this.collide(e);
        if ((e instanceof Tank || e instanceof AI) && !e.ded && Engine.collision(x, y, 10, 10, e.x, e.y, size, size)) return this.collide(e);
      }
    }
