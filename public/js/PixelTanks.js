class PixelTanks {
    ...
    Menus.menus = {
      ...
      shop2: {
        buttons: [
          ...
          [726, 404, 176, 176, function() {PixelTanks.purchase(0)}, true],
          [942, 404, 176, 176, function() {PixelTanks.purchase(1)}, true],
          [1158, 404, 176, 176, function() {PixelTanks.purchase(4)}, true],
          [726, 620, 176, 176, function() {PixelTanks.purchase(2)}, true],
          [942, 620, 176, 176, function() {PixelTanks.purchase(5)}, true],
          [1158, 620, 176, 176, function() {PixelTanks.purchase(3)}, true],
        ],
        listeners: {},
        cdraw: function() {
          GUI.drawText(PixelTanks.userData.stats[0]+' coinage', 800, 350, 50, 0x000000, 0.5);
  ...
  static openCrate(type) {
    const price = type ? 5 : 1, name = type ? 'deathEffects' : 'cosmetics', rand = Math.floor(Math.random()*1001), crate = [{
      ...
      uncommon: ['glitch', 'half glitch', 'eye', 'Anime Eyes', 'Angry Eyes', 'Hard Hat', 'Present', 'Dead', 'Peace', 'Question Mark', 'Small Scratch', 'Kill = Ban', 'Reindeer Hat', 'Pumpkin Hat', 'Cat Ears', 'Cake', 'Cat Hat', 'bread', 'First Aid', 'silver', 'Fisher Hat', 'chip', 'eyes', 'zombie', 'googly'],
