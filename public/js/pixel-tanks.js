...
function Game() {
  ...
  class Tank {
    ...
    drawTank(t) {
      ...
      if ((!t.ded && getTeam(this.team) === getTeam(t.team)) || (this.ded) || (PixelTanks.userData.class === 'tactical' && !t.ded && !t.invis) || (PixelTanks.userData.class === 'tactical' && !t.ded && Math.sqrt(Math.pow(t.x-this.tank.x, 2)+Math.pow(t.y-this.tank.y, 2)) < 200)) {
        GUI.draw.fillStyle = '#000000';
