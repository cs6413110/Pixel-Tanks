  ...
  class Menu {
    ...
    draw() {
      ...
      for (const b of this.buttons) {
        ...
        const data = GUI.draw.getImageData(b[0]/1600*700*PixelTanks.resizer, b[1]/1000*438*PixelTanks.resizer, b[2]/1600*700*PixelTanks.resizer, b[3]/1000*438*PixelTanks.resizer);
