...
function Game() {
  ...
  class Tank {
    ...
    frame() {
      ...
      GUI.drawImage(PixelTanks.images.items["powermissleui"], 418, 900, 100, 100, 1);
      GUI.drawImage(PixelTanks.images.items["toolkitui"], 1132, 900, 100, 100, 1);
      GUI.drawImage(PixelTanks.images.items["boostui"], 1212, 900, 100, 100, 1);
      for (let i = 0; i < 3; i++) {
      ...
      GUI.drawImage(PixelTanks.images.items[PixelTanks.userData.class+"ui"], 348, 900, 100, 100, 1);
