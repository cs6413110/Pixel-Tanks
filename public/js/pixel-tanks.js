    ...
    keyStart(e) {
      ...
      if (k === 9) {
        ...
        if (this.canToolkit) {
          ...
          setTimeout(() => {if (this.halfSpeed && Date.now()-this.timers.toolkit < (PixelTanks.userData.class === 'medic' ? 5000 : 7500) {this.canClass = false;}}, PixelTanks.userData.class === 'medic' ? 5000 : 7500);
