class Block {
  ...
  init(x, y, type, team, host) {
    ...
    if (type === 'airstrike') this.t.push(setTimeout(e => {
      for (let i = 0; i < 5; i++) this.host.d.push(A.template('Damage').init(this.x+[-50, -50, 200, 200, 100][i], this.y+[-50, -50, 200, 200, 100][i], 150, 150, 200, this.team, this.host));
    }, this.timer*1000));
