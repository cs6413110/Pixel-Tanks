class Block {
  ...
  init(x, y, type, team, host) {
    ...
    if (type === 'airstrike' && this.timer < 0) this.t.push(setTimeout(() => this.host.b.push(A.template('Block').init(this.x+50, this.y+50, 'crate', this.team, this.host)), this.timer*1000+Math.random()*200));
