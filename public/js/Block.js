class Block {
  ...
  init(x, y, type, team, host) {
    ...
    if (!(this.c = !['fire', 'airstrike', 'smoke', 'spike'].includes(type))) if (type !== 'spike') this.sd = setTimeout(() => this.destroy(), type === 'fire' ? 2500 : (type === 'smoke' ? 10000 : Math.abs(this.timer)*1000+200));
