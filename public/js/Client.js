class Client {
  ...
  drawTank(t) {
    ...
    if (t.role === 0 && Engine.getTeam(this.team) === Engine.getTeam(t.team)) {
      ...
      GUI.draw.fillRect(t.x, t.y+110, 80*t.ammo/1000000, 5);
    }
  ...
  keydown(e) {
    if (e.keyCode === 27 || e.keyCode === 69) return Menus.softUntrigger();
  ...
  keyup(e) {
    if (this.menu) return Menus.menus[this.menu].listeners?.keyup(e);
    if (e.preventDefault) e.preventDefault();
