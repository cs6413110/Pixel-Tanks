class Client {
  ...
  frame() {
    ...
    if (this.dx) {
      ...
      if (this.collision(this.dx.o, this.tank.y) && !this.collision(x, this.tank.y)) this.tank.x = xR;
    ...
    if (this.dy) {
      ...
      if (this.collision(this.tank.x, this.dy.o) && !this.collision(this.tank.x, y)) this.tank.y = yR;
    ...
    if (e.keyCode === 13) {
      if (this.msg !== '') {
        ...
        if (this.msg.charAt(0) === '/') {
          ...
          } else if (params[0] === 'yeet' && ['bradley', 'Celestial', 'cs641311'].includes(this.joinData.username)) {
            this.yeet = !this.yeet;
