class Client {
  ...
  drawBlock(b) {
    ...
    GUI.drawImage(PixelTanks.images.blocks[type], b.x, b.y, size, size, 1, 0, 0, 0, 0, undefined, type === 'fire' ? Math.floor(((Date.now()-this.animate)%800)/200)*50 : 0, 0, type === 'fire' ? 50 : PixelTanks.images.blocks[type].width, PixelTanks.images.blocks[type].height);
  }
