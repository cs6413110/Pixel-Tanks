class Client {
  ...
  drawBlock(b) {
    ...
    /*if (b.type === 'void') {
      ...
      GUI.drawImage(PixelTanks.images.blocks[corner2], b.x, b.y, 100, 100, 1, 0, 0, 0, 0, undefined, 0, 0, 50, 50);
      GUI.drawImage(PixelTanks.images.blocks[corner1], b.x+50, b.y, 100, 100, 1, 0, 0, 0, 0, undefined, 0, 0, 50, 50);
      GUI.drawImage(PixelTanks.images.blocks[corner3], b.x, b.y+50, 100, 100, 1, 0, 0, 0, 0, undefined, 0, 0, 50, 50);
      GUI.drawImage(PixelTanks.images.blocks[corner4], b.x+50, b.y+50, 100, 100, 1, 0, 0, 0, 0, undefined, 0, 0, 50, 50);
    }
  ...
  drawExplosion(e) {
    ...
    if (e.w !== 200) GUI.drawImage(PixelTanks.images.animations[(e.w === 49 ? 'heal' : '')+'explosion'], e.x, e.y, e.w, e.h, 1, 0, 0, 0, 0, undefined, e.f*50, 0, 50, 50);
  }
  ...
  useItem(id, slot) {
    ...
    if (id === 'duck_tape') {
      ...
      this.fire('usb');
      cooldown = ;
