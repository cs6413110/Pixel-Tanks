window.sourceMap = {
  ...
  cosmetic: {
    ...
    rare: ['blue_tint', 'glitch', 'blue_helmet', 'white_helmet', 'helmet', 'gold_helmet', 'hacker_hoodie', 'purple', 'sus', 'veins', 'cookie', 'dark_crown', 'lostcrown', 'blue_crown'],
    epic: ['christmas_hat', 'christmas_lights', 'dizzy', 'rage', 'toxic', 'darkcrown', 'error', 'crown', 'supersight'],
    legendary: ['plasma', 'cry', 'missing'],    //imma just delete the cosmetic
    admin: ['hoodie'], // LOL IT NEEDS ADMIN TO NOT EPLODE DELETE IT THEN
