class Tank {
  ...
  damageCalc(x, y, a, u) {
    ...
    if (this.hp <= 0 && this.host.ondeath) if (!core || Math.random() > 0.50) return setTimeout(() => this.host.ondeath(this, this.host.pt.concat(this.host.ai).find(t => t.username === u)), boom ? 1000 : 0); else this.core = Date.now();
