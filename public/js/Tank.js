class Tank {
  ...
  grappleCalc() {
    ...
    if (!this.chunk && this.socket && (Math.floor((ox+40)/100) !== Math.floor((this.x+40)/100) || Math.floor((oy+40)/100) !== Math.floor((this.y+40)/100))) this.chunk = this.host.chunkload(this, this.x, this.y);
  }
  reset() {
